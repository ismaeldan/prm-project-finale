...
function generateHomeContent() {
  ...
  <main style="padding: 20px 0px">
    <main>
      <section id="home">
        <div class="_container__home_fcl6o_13 container">
          <div class="_text__home_fcl6o_81">
            <h1>Gravações Personalizadas com Excelência.</h1>
            <p>
              Transformamos sua marca em presença: gravações com precisão,
              estilo e qualidade.
            </p>
            <a class="_button_fcl6o_117" href="/servicos"
              >Conheça nossos serviços</a
            >
          </div>
          <div class="_image__home_fcl6o_31">
            <img
      ...
      <section id="services">
        <div class="_container__services_fcl6o_163 container">
          <div class="_services__title_fcl6o_173">
          ...
          <div class="_services__cards_fcl6o_197">
      ...
      <section id="contact">
        <div class="_container__contact_fcl6o_273 container">
          <div class="_contact__text_fcl6o_291">
            <h2>Entre em Contato</h2>
            <p>
              Entre em contato com a PRM TecPrint, queremos tirar suas dúvidas.
            </p>
            <a
              class="_button_fcl6o_117"
  ...
  "
          ...
          <div>
            <ul class="_contact__list_fcl6o_323">
              <li>
    ...
    <main id="home_services" class="_services_15ssi_3">
      <div class="container">
        ...
        <div id="dtf" class="_service__item_15ssi_23">
          ...
          <img alt="Imagem DTF" src="/assets/dtf-CZaipeeC.webp" />
        </div>
        <div id="laser" class="_service__item_15ssi_23">
          <img alt="Imagem laser" src="/assets/laser-D5jah1n_.webp" />
        ...
        <div id="silk_screen" class="_service__item_15ssi_23">
          ...
          <img alt="Imagem Silk" src="/assets/silk-xXncKGaV.webp" />
        </div>
        <div id="sublimacao" class="_service__item_15ssi_23">
          <img alt="Imagem Sublimação" src="/assets/sublimacao-wTROGEmt.webp" />
          <div class="_service__item__content__reverse_15ssi_51">
            <div class="_line_15ssi_61"></div>
            <h2>Sublimação</h2>
            <p>
        ...
        <div class="_service__item_15ssi_23">
          ...
          <img
            ...
            src="/assets/tampografia-g-xFPHAq.webp"
          />
        </div>
        <div id="transfer" class="_service__item_15ssi_23">
          <img alt="Imagem Transfer" src="/assets/transfer-Bj0defQ_.webp" />
          <div class="_service__item__content__reverse_15ssi_51">
            <div class="_line_15ssi_61"></div>
            <h2>Transfer</h2>
            <p>
        ...
        <div class="_service__item_15ssi_23">
          ...
          <img alt="Imagem Digital" src="/assets/digital-DBXoKlYu.webp" />
        </div>
        <div id="digital360" class="_service__item_15ssi_23">
          <img
            alt="Imagem Digital 360"
            src="/assets/digital360-DZtD0sei.webp"
          />
          <div class="_service__item__content__reverse_15ssi_51">
            <div class="_line_15ssi_61"></div>
  ...
  <main style="padding: 20px 0px">
    <main>
      ...
      <div class="_service__item_1vr1o_9 container">
        <img alt="Imagem laser" src="/assets/transfer-Bj0defQ_.webp" />
...
function generateServiceDigitalContent() {
  ...
  <main style="padding: 20px 0px">
    <main>
      ...
      <div class="_service__item_1bhp7_9 container">
        <img alt="Imagem laser" src="/assets/digital-DBXoKlYu.webp" />
...
function generateServiceDigital360Content() {
  ...
  <main style="padding: 20px 0px">
    <main id="services">
      ...
      <div class="_service__item_1bhp7_9 container">
        <img alt="Imagem laser" src="/assets/digital360-DZtD0sei.webp" />
...
function generateServiceSublimacaoContent() {
  ...
  <main style="padding: 20px 0px">
    <main>
      ...
      <div class="_service__item_1bhp7_9 container">
        <img alt="Imagem Sublimacao" src="/assets/sublimacao-wTROGEmt.webp" />
...
function generateServiceTampografiaContent() {
  ...
  <main style="padding: 20px 0px">
    <main>
      ...
      <div class="_service__item_1bhp7_9 container">
        <img alt="Imagem Tampografia" src="/assets/tampografia-g-xFPHAq.webp" />
...
const routes = [
  ...
  },
  {
    ...
    title: 'Gravação Digital UV - PRM Gravações',
    description:
  ...
  },
  {
    ...
    title: 'Gravação Digital UV 360 - PRM Gravações',
    description:
