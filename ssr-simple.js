...
function generateServicesContent() {
  ...
  <header id="header" class="undefined">
    <nav class="_header_vz7lq_13 container">
      ...
      <div class="_menu_vz7lq_26">
        ...
        ><a class="_active_vz7lq_43" href="/servicos">Serviços</a
        ><a class="" href="/prw">PRW Embalagens</a
        ><a class="" href="/fale-conosco">Contato</a>
      </div>
      <button class="_menuToggle_vz7lq_68" aria-label="Toggle menu">
  ...
  <main style="padding: 20px 0px">
    <main id="home_services" class="_services_enjfu_2">
      <div class="container">
        <h1>Conheça nossos serviços</h1>
        <div class="_service__item_enjfu_12">
          <img
            alt="Imagem baixo relevo"
            src="/assets/BAIXO%20RELEVO-CapiyM4d.jpg"
          />
          <div id="baixo_relevo" class="_service__item__content_enjfu_25">
            <div class="_line_enjfu_31"></div>
            <h2>Baixo Relevo</h2>
            <p>
            ...
            <div class="_centerButton_enjfu_37">
              <a
                class="_button_enjfu_42"
                href="/gravacao-em-baixo-relevo"
                data-discover="true"
                >Conheça mais</a
              >
            </div>
        ...
        <div id="dtf" class="_service__item_enjfu_12">
          <div class="_service__item__content__reverse_enjfu_26">
            <div class="_line_enjfu_31"></div>
            <h2>DTF</h2>
            <p>
            ...
            <div class="_centerButton_enjfu_37">
              <a class="_button_enjfu_42" href="/dtf" data-discover="true"
                >Conheça mais</a
              >
            </div>
            <div class="_line_enjfu_31"></div>
        ...
        <div id="laser" class="_service__item_enjfu_12">
          <img alt="Imagem laser" src="/assets/LASER-HmNWMDNR.jpg" />
          <div class="_service__item__content_enjfu_25">
            <div class="_line_enjfu_31"></div>
            <h2>Laser</h2>
            <p>
        ...
        <div id="silk_screen" class="_service__item_enjfu_12">
          <div class="_service__item__content_enjfu_25">
            <div class="_line_enjfu_31"></div>
            <h2>Silk Screen</h2>
            <p>
            ...
            <div class="_centerButton_enjfu_37">
              <a class="_button_enjfu_42" href="/silk" data-discover="true"
                >Conheça mais</a
              >
            </div>
            <div class="_line_enjfu_31"></div>
        ...
        <div id="sublimacao" class="_service__item_enjfu_12">
          <img
            alt="Imagem Sublimação"
            src="/assets/SUBLIMA%C3%87%C3%83O-B_n2aK7s.jpg"
          />
          <div class="_service__item__content__reverse_enjfu_26">
            <div class="_line_enjfu_31"></div>
            <h2>Sublimação</h2>
        ...
        <div class="_service__item_enjfu_12">
          <div id="tampografia" class="_service__item__content_enjfu_25">
            <div class="_line_enjfu_31"></div>
            <h2>Tampografia</h2>
            <p>
        ...
        <div id="transfer" class="_service__item_enjfu_12">
          ...
          <div class="_service__item__content__reverse_enjfu_26">
            ...
            <div class="_centerButton_enjfu_37">
              <a class="_button_enjfu_42" href="/transfer" data-discover="true"
                >Conheça mais</a
              >
            </div>
            <div class="_line_enjfu_31"></div>
        ...
        <div class="_service__item_enjfu_12">
          <div id="digital" class="_service__item__content_enjfu_25">
            <div class="_line_enjfu_31"></div>
            ...
            <div class="_centerButton_enjfu_37">
              <a class="_button_enjfu_42" href="/digital" data-discover="true"
                >Conheça mais</a
              >
            </div>
            <div class="_line_enjfu_31"></div>
        ...
        <div id="digital360" class="_service__item_enjfu_12">
          <img
            alt="Imagem Digital 360"
            src="/assets/DIGITAL%20360%C2%B0-5pKiqwhI.jpg"
          />
          <div class="_service__item__content__reverse_enjfu_26">
            <div class="_line_enjfu_31"></div>
        ...
        <div class="divider-2"></div>
        <section id="contact">
          <div class="_container__contact_enjfu_65 container">
            <div class="_contact__text_enjfu_74">
              <h2>Entre em Contato</h2>
              <p>
        ...
        "
            ...
            <div>
              <ul class="_contact__list_enjfu_90">
                <li>
                  <a href="tel:11939006543"
                    ><img
                      alt="Phone Icon"
...
function generateServiceTransferContent() {
  ...
  <main style="padding: 20px 0px">
    <main>
      <div class="_service__item_1pngg_5 container">
        ...
        <div id="digital" class="_service__item__content_1pngg_18">
          ...
          <div class="_centerButton_1pngg_30">
            <a class="_button_1pngg_84" href="/servicos" data-discover="true"
              >Mais Serviços</a
            >
          </div>
          <div class="_line_1pngg_24"></div>
      ...
      <div class="divider-2"></div>
      <section id="contact">
        <div class="_container__contact_1pngg_37 container">
          <div class="_contact__text_1pngg_46">
            <h2>Entre em Contato</h2>
            <p>
              Entre em contato com a PRM TecPrint, queremos tirar suas dúvidas.
            </p>
            <a
              class="_button_1pngg_84"
              href="https://wa.me/5511939006543?text=Ol%C3%A1%2C%20quero%20conhecer%20melhor%20os%20seus%20produtos
        "
              target="_blank"
              ><img
          ...
          <div>
            <ul class="_contact__list_1pngg_62">
              <li>
                <a href="tel:11939006543"
                  ><img
                    alt="Phone Icon"
